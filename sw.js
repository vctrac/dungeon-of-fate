const CACHE = 'dungeon-of-fate-v2.20-1';
const SHELL = ['./index.html', './card_frame.png', './manifest.webmanifest', './icons/icon-192.png', './icons/icon-512.png', './icons/apple-touch-icon.png'];
